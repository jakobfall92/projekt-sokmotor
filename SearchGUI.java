...
public class SearchGUI extends JFrame {
    ...
    JRadioButtonMenuItem personalizedItem = new JRadioButtonMenuItem( "Personlized Search" );
	...
	optionsMenu.add( personalizedItem );
	...
	String[] selections = { "This is where your results will show..." };
	...
	JTextArea filePreview = new JTextArea(10, 20);
	filePreview.setLineWrap(true);
	JScrollPane fileScroller = new JScrollPane();
	fileScroller.setViewportView(filePreview);
	...
	Action setPersonlizedSearch = new AbstractAction() {
		public void actionPerformed( ActionEvent e ) {
	...
	MouseListener mouseListener = new MouseAdapter() {
		...
		private void userRequest(String selectedDoc) {
			
			try
			{
				//String filename = selectedDoc.substring(0,selectedDoc.length()-2);
				System.out.println("Detta funkar iaf: " + selectedDoc + "OCH:   " + System.getProperty("user.dir"));
				File f = new File("davisWiki/" + selectedDoc);
				StringBuffer buf = new StringBuffer();
				...
				filePreview.setText( buf.toString() );
